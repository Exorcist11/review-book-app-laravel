...
@section('admin')
    <div>
        <div class="flex items-center gap-4 ">
            ...
            <a href={{ url('/admin/category/detail') }} class="hover:opacity-80">Detail</a>
        </div>

        <div class="flex justify-center">
            <div class="border rounded-md mt-3 w-2/3">
                <div class="px-5 py-1 bg-[#f2f3f5] border-b">
                    <p class="uppercase">Detail category</p>
                </div>
                <div class="flex justify-center">
                    <form action="/admin/category/create" method="POST">
                        ...
                        <div class="flex gap-3 p-3 items-center">
                            ...
                            <div class="border w-[400px]">
                                <input type="text" name="categoryName" id=""
                                    value="{{ $category->categoryName }}" class="w-full outline-none px-2 py-0.5" readonly>
                            </div>
                        </div>
                        ...
                        <div class="flex gap-3 p-3">
                            ...
                            <div class="border w-[400px] text-left px-2 py-0.5">
                                <textarea disabled type="text" name="description" id="" class="w-full outline-none h-32 resize-none">{{ $category->description }}</textarea>
                            </div>
                        </div>
